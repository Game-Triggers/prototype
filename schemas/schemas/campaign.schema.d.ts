...
export declare const CampaignSchema: Schema<ICampaign, Model<ICampaign, any, any, any, import("mongoose").Document<unknown, any, ICampaign, any, {}> & ICampaign & Required<{
    _id: import("mongoose").Types.ObjectId;
}> & {
    __v: number;
}, any>, {}, {}, {}, {}, import("mongoose").DefaultSchemaOptions, ICampaign, import("mongoose").Document<unknown, {}, import("mongoose").FlatRecord<ICampaign>, {}, import("mongoose").ResolveSchemaOptions<import("mongoose").DefaultSchemaOptions>> & import("mongoose").FlatRecord<ICampaign> & Required<{
    _id: import("mongoose").Types.ObjectId;
}> & {
    __v: number;
}>;
